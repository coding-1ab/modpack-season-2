...
public class BlazeComposerRenderer extends BlazeBlockRenderer<BlazeComposerBlockEntity> {
    private final ItemRenderer itemRenderer;

    public BlazeComposerRenderer(Context context) {
        super(context);
        this.itemRenderer = context.getItemRenderer();
    }

    @Override
    protected void renderSafe(BlazeComposerBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay) {
    ...
    protected void renderItem(BlazeComposerBlockEntity blockEntity, ItemStack item, int slot, int processingTime, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay) {
