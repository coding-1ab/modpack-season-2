...
public class BOPIntegration {
    ...
    public BOPIntegration(IEventBus modBus) {
        BOPIntegrationBlocks.register(modBus);
        BOPIntegrationItems.register(modBus);
    }

    @SubscribeEvent
    public void onCommonSetup(final FMLCommonSetupEvent event) {
        event.enqueueWork(BOPIntegrationBlocks::registerCauldronInteractions);
    }
