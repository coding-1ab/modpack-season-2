...
public class SEPonderScenes {
    ...
    public static void fan(final SceneBuilder builder, final SceneBuildingUtil util) {
        ...
        scene.overlay().showText(80)
                ...
                .attachKeyFrame();
        world.setBlock(util.grid().at(2, 3, 3), CDPFluids.DYES_BY_VARIANT.get(ResourceLocation.withDefaultNamespace("lime")).getSource().defaultFluidState().createLegacyBlock(), false);
        scene.idle(15);
