...
public class CDPSECommonConfig extends ConfigBase {
    public final CDPSEFeaturesConfig features = nested(1, CDPSEFeaturesConfig::new,
            Comments.features,
    ...
    public String getName() {
        return "common-simulated-extension";
    }

    static class Comments {
        static final String features = "Enable/Disable features of Create: Dragons Plus - Create: Simulated series Extension";
