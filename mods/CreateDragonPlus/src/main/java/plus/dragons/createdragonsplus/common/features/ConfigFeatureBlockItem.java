...
public class ConfigFeatureBlockItem extends BlockItem implements ConfigFeatureElement {
    public <B extends Block & ConfigFeatureElement> ConfigFeatureBlockItem(B block, Properties properties) {
        super(block, properties);
    }

    @Override
    public ConfigFeature getFeatureConfig() {
        return ((ConfigFeatureElement) this.getBlock()).getFeatureConfig();
    }
}
