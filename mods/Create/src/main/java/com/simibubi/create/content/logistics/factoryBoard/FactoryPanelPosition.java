...
public record FactoryPanelPosition(BlockPos pos, PanelSlot slot) {
	public static Codec<FactoryPanelPosition> CODEC = RecordCodecBuilder.create(instance -> instance.group(
	...
	public static StreamCodec<ByteBuf, FactoryPanelPosition> STREAM_CODEC = StreamCodec.composite(
