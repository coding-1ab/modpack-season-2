...
public class CLogistics extends ConfigBase {
	...
	public final ConfigInt logisticalLinkRange = i(256, 1, "logisticalLinkRange", Comments.logisticalLinkRange);
	...
	private static class Comments {
		...
		static String logisticalLinkRange =
			"Maximum possible distance in blocks between logistical links and their target.";
