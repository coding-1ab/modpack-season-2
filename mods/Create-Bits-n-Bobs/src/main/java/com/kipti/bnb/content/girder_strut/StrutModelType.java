...
public enum StrutModelType {
    WEATHERED(BnbPartialModels.WEATHERED_GIRDER_STRUT_SEGMENT, CreateBitsnBobs.asResource("block/weathered_industrial_iron_block")), NORMAL(BnbPartialModels.GIRDER_STRUT_SEGMENT, Create.asResource("block/industrial_iron_block"));
