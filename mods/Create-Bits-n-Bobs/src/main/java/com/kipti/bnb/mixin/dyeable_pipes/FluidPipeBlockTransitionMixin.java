...
public class FluidPipeBlockTransitionMixin {
    ...
    private void bnb$cacheColorBeforeGlass(final Level level, final BlockPos pos, final Operation<Void> original) {
    ...
    private void bnb$loadColorAfterGlass(final Level level, final BlockPos pos, final Operation<Void> original) {
        original.call(level, pos);
