package com.kipti.bnb.content.decoration.nixie.foundation;
...
public class DoubleOrientedBlockModel extends BakedModelWrapper<BakedModel> {
    ...
    private List<BakedQuad> transformQuads(final List<BakedQuad> quads, final PoseStack poseStack) {
        ...
        for (final BakedQuad quad : quads) {
            ...
            final Direction newNormal = Direction.getNearest(quadNormalJoml.x, quadNormalJoml.y, quadNormalJoml.z);//TODO: from direint
