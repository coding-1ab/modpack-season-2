...
public class BnbKineticBlocks {
    ...
    public static final BlockEntry<EmptyFlangedGearBlock> SMALL_FLANGED_COGWHEEL = REGISTRATE.block(
            ...
            .model((c, p) -> p.withExistingParent(
                    c.getName(),
                    CreateBitsnBobs.asResource("block/flanged_gear/small_cogwheel")
            ))
            .build()
    ...
    public static final BlockEntry<EmptyFlangedGearBlock> LARGE_FLANGED_COGWHEEL = REGISTRATE.block(
            ...
            .model((c, p) -> p.withExistingParent(
                    c.getName(),
                    CreateBitsnBobs.asResource("block/flanged_gear/large_cogwheel")
            ))
            .build()
            ...
            .blockstate((ctx, prov) -> prov.getVariantBuilder(ctx.getEntry())
                    .forAllStates(state -> {
                        ...
                        return ConfiguredModel.builder()
                                .modelFile(axis == Direction.Axis.Z ? AssetLookup.partialBaseModel(
                                        ctx,
                                        prov,
                                        "z"
    ...
    public static final BlockEntry<GiganticCogwheelBlock> GIGANTIC_COGWHEEL =
            REGISTRATE.block("gigantic_cogwheel", GiganticCogwheelBlock::new)
                    ...
                    .blockstate((c, p) -> BlockStateGen.axisBlock(
                            ...
                            p,
                            (s) -> p.models().getExistingFile(CreateBitsnBobs.asResource(
                                    "block/gigantic_cogwheel/cogwheel"))
                    ))
                    .item()
                    .model((c, p) -> p.withExistingParent(
                            c.getName(),
                            CreateBitsnBobs.asResource("block/gigantic_cogwheel/cogwheel")
                    ))
                    .build()
                    .register();
            ...
            REGISTRATE.block("gigantic_cogwheel_satellite", GiganticCogwheelSatelliteBlock::new)
                    ...
                    .blockstate((c, p) -> p.simpleBlock(
                            ...
                            p.models().getExistingFile(
                                    CreateBitsnBobs.asResource("block/gigantic_cogwheel/empty")
                            )
                    ))
                    .register();
