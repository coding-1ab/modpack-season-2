...
public enum VeilShaderUploader {
    NONE {
        @Override
        public void compileGLSL(int shader, int type, String fileName, String source) {
            GlStateManager.glShaderSource(shader, List.of(source));
        }
    },
    ARB {
        @Override
        public void compileGLSL(int shader, int type, String fileName, String source) throws ShaderException {
            try (SPIRV spirv = compileGLSL(fileName, source, type); MemoryStack stack = MemoryStack.stackPush()) {
    ...
    public static SPIRV compileGLSL(String fileName, String source, int type) throws ShaderException {
        ...
        long result = shaderc_compile_into_spv(compiler, source, KIND_MAP.get(type), fileName, "main", MemoryUtil.NULL);
        try {
    ...
    public abstract void compileGLSL(int shader, int type, String fileName, String source) throws ShaderException;
