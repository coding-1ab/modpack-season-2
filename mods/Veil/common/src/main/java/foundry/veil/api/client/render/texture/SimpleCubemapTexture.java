...
/**
 * Implementation of {@link CubemapTexture} that loads all textures the same way as {@link CubeMap}.
 *
 * @author Ocelot
 */
public class SimpleCubemapTexture extends CubemapTexture {

    private final int[] width;
    private final int[] height;

    public SimpleCubemapTexture() {
